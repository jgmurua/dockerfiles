...
REM aqui ejecuta el container con mi entorno de trabajo personalizado con docker in docker
docker run -ti --privileged --rm -v %variable%/:/workdir utils-ubuntu-dind-multi 
